...
Below is the code used to run the models.

> Note! Following will take some time on normal computer. On cloud computing 
environment with 40 core machine with 177 Gb of RAM this took less than one hour. 
...
stop and even slightly increase when k is over 10. Let's pick value 15 for k
...
Let's try to calculate how much there is similarity vs difference in topics between 
different models.
